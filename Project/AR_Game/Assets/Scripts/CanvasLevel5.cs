...
public class CanvasLevel5 : MonoBehaviour
{
    public GameObject CatTextReady, ReadyButton, ShootImage, ShootButton, LooseText, QButtons, RButton, CanvasLevel6obj;
    ...
    void Update()
    {
        ...
        if (GameData.ChairPlaced == true && ready2 == false)
        {
        ...
        {
            Instantiate(CanvasLevel6obj);
            var Canvas3 = GameObject.FindGameObjectWithTag("Canv5");
            ready2 = false;
            Destroy(Canvas3);
        }
    }
